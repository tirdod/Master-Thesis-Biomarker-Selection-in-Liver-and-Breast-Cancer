...
write.csv(
  ...
  "/Users/inigo/Downloads/selected_genes_ridge_y_os.csv",
  row.names = FALSE
)
...
cat("Adaptive Ridge selected", nrow(coef_df_adapt_non_zero), "genes (from post-selection).\n")
...
plot(roc_adapt, legacy.axes = TRUE, print.thres = TRUE, print.thres.col = "darkgreen", main = "ROC - Adaptive Ridge (Test Set)")
...
# Save to CSV
write.csv(
  selected_genes_adaenet,
  "C:/Users/usuario/OneDrive/Desktop/Thesis/personal_files/breastselected/selected_genes_adaenet_y_os.csv",
  row.names = FALSE
)
```
